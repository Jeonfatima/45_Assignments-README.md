...
console.log("Equality test:", ("Fatima Salman" as string ) === "Fatima Salman")
console.log("Equality test:", ("Fatima Salman" as string ) === "Haya salman")
...
console.log("Inequality test" , (100 as number ) !== 4)
