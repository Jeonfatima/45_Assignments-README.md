...
let currentUsers: string[] = ["Amani Sohail", "Ahmed Salman", "Erin Cowper", "Stacie Jules", "Teesha Prakash"];
let newUsers: string[] = ["Mahnoor Ali", "Fatima Salman", "Stacie Jules", "Hania Sheikh", "Ahmed Salman"];
